...
def test_insert_into_starting_with_an_empty_list_ten_items_descending():
    items_to_insert = [ 31, 5, 75, 3, 25, 45, 80, 4, 93, 7 ]
    item_list = []
    for item in items_to_insert:
        insert_into(item_list, item, ascending=False)
    assert item_list == [93, 80, 75, 45, 31, 25, 7, 5, 4, 3], "Successfully inserted in descending order ten items into a list"
