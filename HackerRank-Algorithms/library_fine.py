...
The first values are the return date and the second are the due date. The years
are the same and the months are the same. The book is  days late. Return .
...
Because d2 < d1, we know that it was returned late (but still within the
same month and year).
...
Per the library's fee structure, we know that our fine will be:
 ...
 15 * (d1 - d2) == 15 X (9 - 6) -- 45  as our output.
